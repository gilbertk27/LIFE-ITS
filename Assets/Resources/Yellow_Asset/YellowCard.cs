...
public class YellowCard : MonoBehaviour{ 
    ...
    private void Start()
    {
        ...
        cardSides = Resources.LoadAll<Sprite>("Yellow_Asset/");
    ...
    private void OnMouseDown()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            //{
                _Skemanimator.SetTrigger("Yellow_pop");
            //}
        }
        if (Input.GetMouseButtonDown(1))
        {
            _Skemanimator.ResetTrigger("Yellow_pop");
        }
    }
    ...
    private IEnumerator RollTheCard()
    {
        ...
        for (int i = 0; i <= 20; i++)
        {
            ...
            randomCardSide = Random.Range(0,30);
